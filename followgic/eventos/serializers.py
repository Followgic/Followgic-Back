...
class listarEventoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Evento
        fields = ['id', 'titulo', 'tipo', 'privacidad', 'link_conferencia', 'descripcion', 'fecha_evento', 'hora_evento', 'aforo', 'foto', 'modalidades', 'comentarios', 'localizacion', 'asistentes', 'usuarios_activos', 'creador', 'token', 'fecha_creacion']
